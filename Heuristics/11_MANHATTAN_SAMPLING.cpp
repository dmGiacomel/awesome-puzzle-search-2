...
// g++ -Ofast -fopenmp 11_MANHATTAN_SAMPLING.cpp Heuristics.cpp ../Utils/IndexFunctions.cpp ../Utils/MovementsHandler.cpp ../puzzle_n_minus_1.cpp Manhattan.cpp -o 11_MANHATTAN_SAMPLING.x
//time ./11_MANHATTAN_SAMPLING.x > 11_MANHATTAN_SAMPLING.txt
