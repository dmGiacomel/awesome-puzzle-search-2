...
// g++ -Ofast -fopenmp 8_MANHATTAN_SAMPLING.cpp Heuristics.cpp ../Utils/IndexFunctions.cpp ../Utils/MovementsHandler.cpp ../puzzle_n_minus_1.cpp Manhattan.cpp -o 8_MANHATTAN_SAMPLING.x
//time ./8_MANHATTAN_SAMPLING.x > 8_MANHATTAN_SAMPLING.txt
